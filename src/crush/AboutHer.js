        ...
        <div ref={containerRef} >
            ...
            <div id="crushAboutHerContainer">
                ...
                <div className="crushHalfContainer">
                    <motion.img src={imgArr[5].src} alt="" id="crushAboutPic" animate={animation} initial={"hidden"} variants={animationVariants(0, 30)} />
                </div>

                <motion.div className="crushHalfContainer" id="crushSecLine" animate={animation} initial={"hidden"} variants={animationVariants(0, 30)}>
